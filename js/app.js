...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Live Atelier Ticker Rotation
  const liveTickerText = document.getElementById('live-ticker-text');
  if (liveTickerText) {
    const liveUpdates = [
      "Master Alagar is currently brewing South Indian Degree Filter Coffee at the counter • Call +91 9600470133 for VIP Reservations",
